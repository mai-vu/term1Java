...
public class CatHotel {
     ...
     * @param ageLim cat that is older than this age limit will be removed
     * @return number of cats removed */
    ...
    public String toString() {
        return "CatHotel [hotelName=" + hotelName 
                + ", catList=" + catList + "]";
    }
